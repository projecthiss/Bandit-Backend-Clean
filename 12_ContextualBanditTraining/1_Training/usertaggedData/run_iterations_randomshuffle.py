...
ax = plt.subplot()
sn.heatmap(df_cm, fmt='g', ax=ax, xticklabels=True, yticklabels=True) #annot=True, fmt='g', ax=ax, xticklabels=True, yticklabels=True);  # annot=True to annotate cells, ftm='g' to disable scientific notation
